        ...
        <div className="grid place-items-center h-screen">
            ...
            <div className="max-w-xs mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <div className="px-4 py-2">
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur
                ...
                <img className="object-cover w-full h-48 mt-2"
                    ...
                    <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
                        ...
                        <button
                          className="px-2 py-1 text-xs font-semibold text-gray-900 uppercase transition-colors duration-200 transform bg-white rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none">Add
                            to cart
                        </button>
                    </div>
            </div>
